          ...
          showText() {
            ...
            for (let i = 0; i < this.text.length; i++) {
              ...
              for (let j = 0; j < this.text[i].length; j++) {
                ...
                let wordByString = document.createTextNode(
                  `${this.text[i][j]}`
                );
                if (hlTest) {
